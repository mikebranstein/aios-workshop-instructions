...
Reads docs/discovery-focus.md from repo, invokes idea-scout LLM to identify market
...
class StubLLMAdapter(JudgmentLLMAdapter):
    ...
    def invoke_json(self, task_type: str, prompt_vars: dict, model_hint: str = "") -> LLMInvocationResult:
        ...
        if task_type == "discovery_idea_scout":
                ...
                "candidates": [
                    {
                        ...
                        "body": "## Opportunity\n\nStub-generated opportunity for smoke-testing.",
            ...
            payload = {}
        return LLMInvocationResult(payload=payload, model=self.model, request_id="stub")
