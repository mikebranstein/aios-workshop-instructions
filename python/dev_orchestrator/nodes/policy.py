...
_DECISION_MAP = {
    "APPROVED": DevEvent.POLICY_APPROVED,
    "REVIEW_REQUIRED": DevEvent.POLICY_REVIEW_REQUIRED,
}
...
class DevPolicyNode:
    ...
    def run(self, run_id: str, issue_number: int) -> DevState:
        return run_dev_stage_node(
            ...
            tool_type="dev_policy", from_state=DevState.DEV_POLICY,
            decision_to_event=_DECISION_MAP, reason_prefix="DEV_POLICY",
        )
