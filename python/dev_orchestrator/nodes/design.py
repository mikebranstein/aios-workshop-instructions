...
_DECISION_MAP = {
    "APPROVED": DevEvent.DESIGN_APPROVED,
    "REVISE": DevEvent.DESIGN_REVISE,
    "BLOCKED": DevEvent.DESIGN_BLOCKED,
}
...
class DevDesignNode:
    ...
    def run(self, run_id: str, issue_number: int) -> DevState:
        return run_dev_stage_node(
            ...
            tool_type="dev_design", from_state=DevState.DEV_DESIGN,
            decision_to_event=_DECISION_MAP, reason_prefix="DEV_DESIGN",
        )
